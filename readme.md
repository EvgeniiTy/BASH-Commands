...
```bash
ps                    # идущие процессы
ctrl+Z                # отправить программу в бэкгроунд (не выключить)
ctrl+C                # полностью выключить программу
fg                    # переключиться на фоновый процесс
locate                # поиск файлов
man -k                # поиск комманды по ключевому слову
man 'комманда'        # мануал комманды
